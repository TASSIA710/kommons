...
dependencies {
    implementation("net.tassia.kommons", "kommons-ini", "1.0.0")
}
```
...
<dependencies>
    <dependency>
        ...
        <artifactId>kommons-ini</artifactId>
...
[➥ View Artifact](https://nexus.tassia.net/#browse/browse:maven-public:net/tassia/kommons/kommons-ini/1.0.0)
